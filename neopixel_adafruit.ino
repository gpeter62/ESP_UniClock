...
void setupNeopixelAdafruit() {  
  DPRINTLN("Setup NeoPixel LEDS (Adafruit lib):");
...
void doAnimationAdafruit() {
  ...
  if (DO_ANIMATION) {
    rainbow(LED_ANIM_SPEED);
    //rainbowCycle(LED_ANIM_SPEED);
  }
}
